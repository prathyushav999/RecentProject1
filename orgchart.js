window.onload = function() {
	...
	OrgChart.templates.myTemplate.plus = '<circle cx="15" cy="15" r="15" fill="#87CEEB" stroke="#ffffff" stroke-width="1"></circle>'
	...
	var chart = new OrgChart(document.getElementById('tree'), {
		...
		enableSearch : false,
		showXScroll : OrgChart.action.scroll,
		toolbar : {
			zoom : true,
			fit : true,
			expandAll : false
		...
		/*
		 * toolbar: { zoom: true, }, enableSearch: false, template:
		 * "myTemplate", nodeBinding: { field_0: "name", field_1: 'title',
		 * img_0: "img" },
		 */
		editUI : new editForm()
	});
	...
	/*
	 * alert("res2"); alert(res2); alert(typeof res2); //
	 * //chart.load(res.toString()); alert("map2") alert(typeof map2) // //
	 * alert(typeof obj); alert(typeof res);
	 */
	chart.load(res2);

	/*
	 * chart.load([ { "img": "https://cdn.balkan.app/shared/5.jpg", "id": "3",
	 * "name": "Chandu", "title": "3" }, { "img":
	 * "https://cdn.balkan.app/shared/5.jpg", "id": "3", "name": "Chandu",
	 * "title": "3" }, { "img": "https://cdn.balkan.app/shared/5.jpg", "id":
	 * "11", "name": "prathyusha", "pid": "3", "title": "SREA-11" }, { "img":
	 * "https://cdn.balkan.app/shared/5.jpg", "id": "12", "name": "Prathyusha",
	 * "pid": "3", "title": "SREA-12" }, { "img":
	 * "https://cdn.balkan.app/shared/5.jpg", "id": "13", "name": "yaswanth",
	 * "pid": "3", "title": "SREA-13" }, { "img":
	 * "https://cdn.balkan.app/shared/5.jpg", "id": "5", "name": "yashu56",
	 * "pid": "3", "title": "SREA-5" }, { "img":
	 * "https://cdn.balkan.app/shared/5.jpg", "id": "21", "name": "chandrika",
	 * "pid": "5", "title": "SREA-21" } ]);
	 */

	/*
	 * chart.load([ { id: "1", name: "Endy Chau", title: "CEO", img:
	 * "https://cdn.balkan.app/shared/2.jpg", email: "my@email.com", phone1:
	 * "+6465 6454 8787", phone2: "+2342 3433 5455", address: "T2" },
	 *  { id: 2, pid: 1, name: "yashu", title: "Senior manager, IT Operations",
	 * img: "https://cdn.balkan.app/shared/4.jpg", email: "my@email.com",
	 * phone1: "+6465 6454 8787", phone2: "+2342 3433 5455", address: "T2"
	 *  }, { id: 3, pid: 1, name: "Eason Lee", title: "Senior manager,
	 * Information Arhitecture", img: "https://cdn.balkan.app/shared/5.jpg",
	 * email: "my@email.com", phone1: "+6465 6454 8787", phone2: "+2342 3433
	 * 5455", address: "T2"
	 *  }, { id: 4, pid: 1, name: "Chun Wa", title: "Senior manager, IT
	 * Systems", img: "https://cdn.balkan.app/shared/6.jpg", email:
	 * "my@email.com", phone1: "+6465 6454 8787", phone2: "+2342 3433 5455",
	 * address: "T2"
	 *  }, { id: 5, pid: 1, name: "P L Ip", title: "Manager HR, Managaer", img:
	 * "https://cdn.balkan.app/shared/7.jpg", email: "my@email.com", phone1:
	 * "+6465 6454 8787", phone2: "+2342 3433 5455", address: "T2"
	 *  }, { id: 6, pid: 4, tags: ["Directors"], name: "Name 1", title: "Title
	 * 1", img: "https://cdn.balkan.app/shared/8.jpg", email: "my@email.com",
	 * phone1: "+6465 6454 8787", phone2: "+2342 3433 5455", address: "T2"
	 *  }, { id: 7, pid: 4, tags: ["Directors"], name: "Name 2", title: "Title
	 * 2", img: "https://cdn.balkan.app/shared/9.jpg", email: "my@email.com",
	 * phone1: "+6465 6454 8787", phone2: "+2342 3433 5455", address: "T2"
	 *  } ]);
	 */
};